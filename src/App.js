                        ...
                        <Col md={4} sm={4}>
                            ...
                            >
                                {PLACES.map((place, index) => (
                                    <NavItem key={index} eventKey={index} className="Nav-item">{place.name}</NavItem>
                                ))}
                            </Nav>
                        </Col>
                        <Col md={8} sm={8}>
...
class WeatherDisplay extends Component {
    ...
    componentDidMount() {
        ...
        const URLforecast = "https://api.openweathermap.org/data/2.5/forecast/daily?id=" +
            id +
    ...
    render() {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            let iconForecast = "https://openweathermap.org/img/w/" + weatherForecast[i].weather[0].icon + ".png";
